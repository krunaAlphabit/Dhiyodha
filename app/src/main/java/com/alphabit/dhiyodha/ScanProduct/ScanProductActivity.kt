package com.alphabit.dhiyodha.ScanProduct
...
import com.alphabit.dhiyodha.Utils.MainViewModel
import com.alphabit.dhiyodha.Utils.MainViewModelFactory
import com.alphabit.dhiyodha.databinding.ActivityScanProductBinding
...
class ScanProductActivity : AppCompatActivity() {
    ...
    private fun setUpToolBar() {
        binding.toolbar.tvTitle.text = "Scan Product"
        ...
        for (id in cameraIds) {
            ...
            if (streamConfigurationMap != null) {
                ...
                imageReader.setOnImageAvailableListener(
                    viewModel.onImageAvailableListener,
                    backgroundHandler
                )
            }
            cameraId = id
    ...
    private fun takePhoto() {
        try {
            ...
            captureRequestBuilder.set(
                ...
                viewModel.orientations.get(rotation)
            )
